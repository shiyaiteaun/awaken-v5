...
export default function EditNewsItem({ params }: { params: { id: string } }) {
          ...
          <form onSubmit={handleSubmit} className="news-form">
            ...
            <div className="form-group">
              ...
              <p className="image-note">
                {formData.imageFile ? 'New image selected' : 'Current image shown. Upload a new one to change.'}
              </p>
            </div>
            ...
            <div className="form-actions">
              ...
              <button
                ...
                disabled={isSaving}
              >
                {isSaving ? 'Saving...' : 'Update News Item'}
              </button>
            </div>
          </form>
        </div>
